...
public class BukguTour4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bukgu_tour4);
        ...
        callbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:053-312-0000"));
    ...
    public void onMapReady(GoogleMap googleMap) {  //구글맵 마커
        LatLng location = new LatLng(35.911447, 128.524295);       //위도경도 지정
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.title("대구 사격장");
