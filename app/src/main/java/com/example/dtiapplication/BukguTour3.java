...
public class BukguTour3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bukgu_tour3);
    ...
    public void onMapReady(GoogleMap googleMap) {  //구글맵 마커
        LatLng location = new LatLng(35.876677, 128.605654);       //위도경도 지정
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.title("칠성야시장");
