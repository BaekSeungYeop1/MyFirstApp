...
public class DonguTour2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dongu_tour2);
        ...
        callbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:053-662-2865"));
    ...
    public void onMapReady(GoogleMap googleMap) {  //구글맵 마커
        LatLng location = new LatLng(35.882697, 128.650589);       //위도경도 지정
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.title("동촌유원지");
